...
public class WaapiManager
{
    ...
    public static HashSet<int> RegistedGameobjectIds = new HashSet<int>();
    ...
    public static void ClearUpdateDelegate() 
    {
        UnityEditor.EditorApplication.update -= Loop;
    }

    public static void ClearAllRegistedGameobjectIds() 
    {
        foreach (var id in RegistedGameobjectIds)
        {
    ...
    public static async void RegisterGameObject(int gameObjectId, string name) 
    {
        ...
        if (!RegistedGameobjectIds.Contains(gameObjectId))
        {
            JObject args = new JObject();
            args["gameObject"] = gameObjectId;
            args["name"] = name;
            ...
            RegistedGameobjectIds.Add(gameObjectId);
        }
    ...
    public static void UnRegisterGameObject(int gameObjectId)
    {
        waapiCallFunctions.Enqueue(async () =>
        {
            ...
            RegistedGameobjectIds.Remove(gameObjectId);
